        ...
        <div className="flex flex-row justify-center align-center">
            ...
            <div className='flex flex-col min-w-[170px] mr-36' style={{ fontFamily: 'Inter, sans-serif' }}>
                ...
                <div className='flex flex-row w-[150px] justify-between'>
                    <a href='https://www.facebook.com/KTPalpha/' target="_blank" rel="noopener noreferrer" class="transition-colors duration-200 text-white hover:text-green-400">
                    ...
                    <a href="https://x.com/KTPAlpha" target="_blank" rel="noopener noreferrer" class="transition-colors duration-200 text-white hover:text-green-400">
                    ...
                    <a href='https://www.instagram.com/ktpumich/' target="_blank" rel="noopener noreferrer" class="transition-colors duration-200 text-white hover:text-green-400">
                        <svg width="20" height="20" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href='https://www.linkedin.com/company/kappa-theta-pi/' target="_blank" rel="noopener noreferrer" class="transition-colors duration-200 text-white hover:text-green-400">
                        <svg width="20" height="20" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='mb-6'>
                    ...
                    <div className='flex flex-row'>
                        ...
                        <a href='https://play.google.com/store/apps/details?id=com.ktpumich.ktp_rush&pli=1' target="_blank" rel="noopener noreferrer">
                            <img src={`${process.env.PUBLIC_URL}/google_play.svg`} alt="Google Play" style={{ width: '130px' }} />
                        </a>
                    </div>
                </div>

                {/* cout */}
                <div className='flex align-center justify-center' style={{ transform: 'rotate(-4deg)' }}>
                    <img src={`${process.env.PUBLIC_URL}/cout_ktp.svg`} alt="Image" style={{ width: '175px' }} />
                </div>
            </div>
        </div>

        <div className='flex justify-center items-center mt-6' style={{ fontFamily: 'Inter, sans-serif' }}>
